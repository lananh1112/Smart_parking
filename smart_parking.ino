...
const char *ssid =  "DucAnh";     // Enter your WiFi Name
const char *pass =  "11122000"; // Enter your WiFi Password

#define MQTT_SERV "io.adafruit.com"
#define MQTT_PORT 1883
#define MQTT_NAME "lananh1112"
#define MQTT_PASS "aio_JTFX87YVS5W9jV79Axc68yHWy56S"
WiFiUDP ntpUDP;
...
int servoPin2 = 1;  // Declare the Servo pin

//sensor
const int carEnter=5;
const int carExited=4;
const int slot1 = 14;
const int slot2 = 12;
const int slot3 = 13;
int count =0; 
...
void setup() {
  ...
  myservo.attach(servoPin2);      // servo pin to D6
  myservos.attach(servoPin);       // servo pin to D5
...
void loop() {
 ...
 s3 = digitalRead(slot3);
   ...
   if (entrysensor == LOW) {                     // if high then count and send data
   if(count < 3)
   {
...
//   delay(3000);
   ...
   if (exitsensor == LOW) {                            //if high then count and send
